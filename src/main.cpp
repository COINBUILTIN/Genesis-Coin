...
uint256 hashGenesisBlock("0x9af21bef51869a0b6e5d85be5aab135fecf8e1053c9bb066be4edafee826b710");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // genesiscoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 10*30; // genesiscoin: 5 minutes
static const int64 nTargetSpacing = 1*30; // genesiscoin: 30 seconds
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x9af21bef51869a0b6e5d85be5aab135fecf8e1053c9bb066be4edafee826b710");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "The Genesis of the GenesisCoin(GEN).";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x97c5faa5493af2f01ffe1bc7b20496ae26a4f69f466c9f210ba6cc32b6198022"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // genesiscoin: increase each by adding 2 to bitcoin's value.
